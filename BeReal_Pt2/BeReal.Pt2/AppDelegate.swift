...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ParseSwift.initialize(applicationId: "Fd5SVG37YRNlhi6w4HaliQ2ccmvGY3E6Saj9nlJs",
                              clientKey: "obQ9aajSpDrmPGWfg9tDMwGYt0bhbiPVg4PFUamT",
...
//                assertionFailure("Error saving: \(error)")
    ...
    func scheduleDailyNotification() {
        ...
        //dateComponents.hour = 9 // Adjust this to the hour you want the notification to be shown
